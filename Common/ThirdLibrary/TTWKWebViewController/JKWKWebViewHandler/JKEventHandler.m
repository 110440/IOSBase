...
- (NSString *)getJsString{
    ...
    NSString * sign = @"";
    NSString * uid  = @"";
    NSString * js = [NSString stringWithFormat:@"window.localStorage.setItem('user_verify_data',JSON.stringify({sign:'%@',user_id:'%@'}));",sign,uid];
    
    handlerJS = [NSString stringWithFormat:@"%@%@",handlerJS,js];
